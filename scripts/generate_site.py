...
document.querySelectorAll('[data-range]').forEach(b=>b.addEventListener('click',()=>setPreset(b.dataset.range))); [dateFromEl,dateToEl].forEach(x=>x.addEventListener('input',renderPeriod));
